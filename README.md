...
### 0.3 Características de los LLM
...
### 0.5 Herramientas para gestionar modelos de lenguaje grande de forma local
...
### 6.7 Enviar una imagen con [curl](https://curl.se) codificada en [Base64](https://developer.mozilla.org/es/docs/Glossary/Base64)
...
## 7. Solicitudes de información a la API

### 7.1 Lista de modelos descargados
...
```json
{"models":[{"name":"gemma:2b","model":"gemma:2b","modified_at":"2024-04-30T15:02:09.169452069Z","size":1678456656,"digest":"b50d6c999e592ae4f79acae23b4feaefbdfceaa7cd366df2610e3072c052a160","details":{"parent_model":"","format":"gguf","family":"gemma","families":["gemma"],"parameter_size":"3B","quantization_level":"Q4_0"}},{"name":"llava:latest","model":"llava:latest","modified_at":"2024-04-30T15:46:36.864969033Z","size":4733363377,"digest":"8dd30f6b0cb19f555f2c7a7ebda861449ea2cc76bf1f44e262931f45fc81d081","details":{"parent_model":"","format":"gguf","family":"llama","families":["llama","clip"],"parameter_size":"7B","quantization_level":"Q4_0"}}]}
```

### 7.2 Información sobre un modelo en particular
